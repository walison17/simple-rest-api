...
if (! function_exists('app')) {
    ...
    {
        /** @var Container */
        $container = Tuiter\Core\Container::instance();
...
{
    /**
     * @return \Tuiter\Core\Auth\Authenticator
     */
    function auth(string $provider = 'default')
    {
...
{
    flash_errors(
        new \Tuiter\Core\Validation\ErrorMessages([
            $field => [$message]
        ])
    );
}
 ...
 *
 * @param \Tuiter\Core\Validation\ErrorMessages $errors
 * @return void
 */
function flash_errors(\Tuiter\Core\Validation\ErrorMessages $errors) 
{
...
function errors()
{
    ...
    return $messages ?: new \Tuiter\Core\Validation\ErrorMessages;
}
